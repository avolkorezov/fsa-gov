...
Class Rss_pub_gost_r extends simpleParser {

    public $data = [];
    public $reload = [];
    public $project = 'rss_pub_gost_r';
    public $project_link = 'http://188.254.71.82';
    public $source = 'http://public.fsa.gov.ru/table_rss_pub_gost_r/';
    public $cache = false;
    public $proxy = false;
    public $cookieFile = '';
    public $version_id = 1;
    public $donor = 'Rss_pub_gost_r';
    ...
    public function getData($url, $source = [])
    {
        $data = false;
        $source['referer'] = $url;
//                $href = "http://188.254.71.82/rss_pub_gost_r/?show=view&id_object=677E6226177746BE8CA807C1092635F5";
        $href = $url;
        ...
        $a_product_info_rss_product_ts_object_type_cert = $nokogiri->get("#a_product_info-rss-product_gost_r-object_type_cert .form-right-col")->toArray();
        $a_product_info_rss_product_ts_product_type = $nokogiri->get("#a_product_info-rss-product_gost_r-product_type .form-right-col")->toArray();
        $a_product_info_rss_product_ts_product_name = $nokogiri->get("#a_product_info-rss-product_gost_r-product_name .form-right-col")->toArray();
        $a_product_info_rss_product_ts_product_info = $nokogiri->get("#a_product_info-rss-product_gost_r-product_info .form-right-col")->toArray();
        $a_product_info_rss_product_ts_okpd2 = $nokogiri->get("#a_product_info-rss-product_gost_r-okpd2 .form-right-col")->toArray();
        $a_product_info_rss_product_ts_okpd2_text = $nokogiri->get("#a_product_info-rss-product_gost_r-okpd2_text .form-right-col")->toArray();
        $a_product_info_rss_product_ts_tn_ved = $nokogiri->get("#a_product_info-rss-product_gost_r-tn_ved .form-right-col")->toArray();
        $a_product_info_rss_product_ts_tn_ved_text = $nokogiri->get("#a_product_info-rss-product_gost_r-tn_ved_text .form-right-col")->toArray();
        $a_product_info_rss_product_ts_name_doc_made_product = $nokogiri->get("#a_product_info-rss-product_gost_r-name_doc_made_product .form-right-col")->toArray();
        $a_product_info_rss_product_ts_product_info_ext = $nokogiri->get("#a_product_info-rss-product_gost_r-product_info_ext .form-right-col")->toArray();
        $a_product_info_rss_product_ts_serial_number_product = $nokogiri->get("#a_product_info-rss-product_gost_r-serial_number_product .form-right-col")->toArray();
        $a_product_info_rss_product_ts_requisites_doc = $nokogiri->get("#a_product_info-rss-product_gost_r-requisites_doc .form-right-col")->toArray();
        ...
        $data[] = [
            ...
            'a_product_info-rss-product_gost_r-object_type_cert' => trim(@$a_product_info_rss_product_ts_object_type_cert[0]['__ref']->nodeValue),
            'a_product_info-rss-product_gost_r-product_type' => trim(@$a_product_info_rss_product_ts_product_type[0]['__ref']->nodeValue),
            'a_product_info-rss-product_gost_r-product_name' => trim(@$a_product_info_rss_product_ts_product_name[0]['__ref']->nodeValue),
            'a_product_info-rss-product_gost_r-product_info' => trim(@$a_product_info_rss_product_ts_product_info[0]['__ref']->nodeValue),
            'a_product_info-rss-product_gost_r-okpd2' => trim(@$a_product_info_rss_product_ts_okpd2[0]['__ref']->nodeValue),
            'a_product_info-rss-product_gost_r-okpd2_text' => trim(@$a_product_info_rss_product_ts_okpd2_text[0]['__ref']->nodeValue),
            'a_product_info-rss-product_gost_r-tn_ved' => trim(@$a_product_info_rss_product_ts_tn_ved[0]['__ref']->nodeValue),
            'a_product_info-rss-product_gost_r-tn_ved_text' => trim(@$a_product_info_rss_product_ts_tn_ved_text[0]['__ref']->nodeValue),
            'a_product_info-rss-product_gost_r-name_doc_made_product' => trim(@$a_product_info_rss_product_ts_name_doc_made_product[0]['__ref']->nodeValue),
            'a_product_info-rss-product_gost_r-product_info_ext' => trim(@$a_product_info_rss_product_ts_product_info_ext[0]['__ref']->nodeValue),
            'a_product_info-rss-product_gost_r-serial_number_product' => trim(@$a_product_info_rss_product_ts_serial_number_product[0]['__ref']->nodeValue),
            'a_product_info-rss-product_gost_r-requisites_doc' => trim(@$a_product_info_rss_product_ts_requisites_doc[0]['__ref']->nodeValue),
