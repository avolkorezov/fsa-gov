...
//        $url = "http://armnab.am/MMCert01RU_view?Number=008/S.A-0021-2017";
...
//        $url = "http://register.armnab.am/R_TR_TS_01_001/docview/23381";
        ...
        foreach ( $ApplicantContactList as $row)
        {
            $APPLICANT_PERS_CONTACTS[] = [
                ...
                'Контакт' => @$row['td'][1]['__ref']->nodeValue,
            ];
        }
...
//        print_r($MANUFACTURER_ADDRESS);die();
        ...
        $data[] = [
            ...
            'STATUS' => @$STATUS,
            'STATUS_DATE_BEGIN' => !empty($STATUS_DATE_BEGIN) ? date('Y-m-d', strtotime($STATUS_DATE_BEGIN)) : null,
