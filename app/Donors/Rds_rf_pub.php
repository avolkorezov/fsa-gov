...
Class Rds_rf_pub extends simpleParser {

    public $data = [];
    public $reload = [];
    public $project = 'rds_rf_pub';
    public $project_link = 'http://188.254.71.82';
    public $source = 'http://public.fsa.gov.ru/table_rds_pub_rf/';
    public $cache = false;
    public $proxy = false;
    public $cookieFile = '';
    public $version_id = 1;
    public $donor = 'Rds_rf_pub';
    ...
    public function getData($url, $source = [])
    {
        $data = false;
        $source['referer'] = $url;
//                $href = "http://188.254.71.82/rds_rf_pub/?show=view&id_object=C5CB33C501844606A514E46A96168AF8";
        $href = $url;
        ...
        $a_cert_type_cert_ts = $nokogiri->get("#a_cert_type-cert_rf .form-left-col .text-label")->toArray();
        ...
        $a_product_info_rss_product_ts_object_type_cert = $nokogiri->get("#a_product_info-rds-product_rf-object_type_cert .form-right-col")->toArray();
        $a_product_info_rss_product_ts_product_type = $nokogiri->get("#a_product_info-rds-product_rf-product_type .form-right-col")->toArray();
        $a_product_info_rss_product_ts_product_name = $nokogiri->get("#a_product_info-rds-product_rf-product_name .form-right-col")->toArray();
        $a_product_info_rss_product_ts_product_info = $nokogiri->get("#a_product_info-rds-product_rf-product_info .form-right-col")->toArray();
        $a_product_info_rss_product_ts_okpd2 = $nokogiri->get("#a_product_info-rds-product_rf-okpd2 .form-right-col")->toArray();
        $a_product_info_rss_product_ts_okpd2_text = $nokogiri->get("#a_product_info-rds-product_rf-okpd2_text .form-right-col")->toArray();
        $a_product_info_rss_product_ts_tn_ved = $nokogiri->get("#a_product_info-rds-product_rf-tn_ved .form-right-col")->toArray();
        $a_product_info_rss_product_ts_tn_ved_text = $nokogiri->get("#a_product_info-rds-product_rf-tn_ved_text .form-right-col")->toArray();
        $a_product_info_rss_product_ts_name_doc_made_product = $nokogiri->get("#a_product_info-rds-product_rf-name_doc_made_product .form-right-col")->toArray();
        $a_product_info_rss_product_ts_product_info_ext = $nokogiri->get("#a_product_info-rds-product_rf-product_info_ext .form-right-col")->toArray();
        $a_product_info_rss_product_ts_serial_number_product = $nokogiri->get("#a_product_info-rds-product_rf-serial_number_product .form-right-col")->toArray();
        $a_product_info_rss_product_ts_requisites_doc = $nokogiri->get("#a_product_info-rds-product_rf-requisites_doc .form-right-col")->toArray();
...
//                print_r($div_a_free_form);die();
        ...
        $data[] = [
            ...
            'a_cert_type-cert_rf' => trim(@$a_cert_type_cert_ts[0]['__ref']->nodeValue),
            ...
            'a_product_info-rds-product_rf-object_type_cert' => trim(@$a_product_info_rss_product_ts_object_type_cert[0]['__ref']->nodeValue),
            'a_product_info-rds-product_rf-product_type' => trim(@$a_product_info_rss_product_ts_product_type[0]['__ref']->nodeValue),
            'a_product_info-rds-product_rf-product_name' => trim(@$a_product_info_rss_product_ts_product_name[0]['__ref']->nodeValue),
            'a_product_info-rds-product_rf-product_info' => trim(@$a_product_info_rss_product_ts_product_info[0]['__ref']->nodeValue),
            'a_product_info-rds-product_rf-okpd2' => trim(@$a_product_info_rss_product_ts_okpd2[0]['__ref']->nodeValue),
            'a_product_info-rds-product_rf-okpd2_text' => trim(@$a_product_info_rss_product_ts_okpd2_text[0]['__ref']->nodeValue),
            'a_product_info-rds-product_rf-tn_ved' => trim(@$a_product_info_rss_product_ts_tn_ved[0]['__ref']->nodeValue),
            'a_product_info-rds-product_rf-tn_ved_text' => trim(@$a_product_info_rss_product_ts_tn_ved_text[0]['__ref']->nodeValue),
            'a_product_info-rds-product_rf-name_doc_made_product' => trim(@$a_product_info_rss_product_ts_name_doc_made_product[0]['__ref']->nodeValue),
            'a_product_info-rds-product_rf-product_info_ext' => trim(@$a_product_info_rss_product_ts_product_info_ext[0]['__ref']->nodeValue),
            'a_product_info-rds-product_rf-serial_number_product' => trim(@$a_product_info_rss_product_ts_serial_number_product[0]['__ref']->nodeValue),
            'a_product_info-rds-product_rf-requisites_doc' => trim(@$a_product_info_rss_product_ts_requisites_doc[0]['__ref']->nodeValue),
