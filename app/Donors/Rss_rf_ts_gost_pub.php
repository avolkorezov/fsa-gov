...
//        $perPage = 10;
        ...
        do
        {
            $nextPage = $currPage + 1;
//            print_r($regDate);die();
            $opt['post'] = "{\"size\":{$perPage},\"page\":{$currPage},\"filter\":{\"regDate\":{\"minDate\":\"{$regDate}\",\"maxDate\":\"{$endDate}\"},\"endDate\":{\"minDate\":\"\",\"maxDate\":\"\"},\"columnsSearch\":[]},\"columnsSort\":[{\"column\":\"date\",\"sort\":\"DESC\"}]}";
