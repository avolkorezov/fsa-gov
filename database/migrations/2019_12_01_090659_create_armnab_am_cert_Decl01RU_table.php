...
class CreateArmnabAmCertDecl01RUTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('armnab_am_certList_Decl01RU', function(Blueprint $table){
            $table->increments('id');
            ...
            $table->string('PRODUCT_CERTOBJECT_TYPE')->nullable()
                ->comment('Данные о продукции. Наименование объекта декларирования');
            ...
            $table->text('ProductTestReport')->nullable()
                ->comment('Оснoвания для принятия декларации о соответствии. Протоколы испытаний (номер, датa, наименования исп. лаб., рег. номер аттестата аккредитации и срок его действия)');
            $table->text('ProductOtherDocuments')->nullable()
                ->comment('Оснoвания для принятия декларации о соответствии. Другие документы');
            $table->text('ProductExtraInfo')->nullable()
                ->comment('Оснoвания для принятия декларации о соответствии. Дополнительная информация');



            $table->text('Attachments')->nullable()
                ->comment('Оснoвания для принятия декларации о соответствии. Приложение (приложения) к декларации о соответствии');

            $table->text('SUSPEND_DATE_CAUSE')->nullable()
                ->comment('Оснoвания для принятия декларации о соответствии. Дата и основания для прекращения действия декларации о соответствии');

            $table->string('HGM_NAME')->nullable()
                ->comment('Оснoвания для принятия декларации о соответствии. Данные о ООС. Наименование ООС');
            $table->string('AC_NUMBER')->nullable()
                ->comment('Оснoвания для принятия декларации о соответствии. Данные о ООС. Рег.номер аттестата аккредитации');

            $table->string('HGM_LEADER_NAME')->nullable()
                ->comment('Оснoвания для принятия декларации о соответствии. Данные о ООС. Руководитель. Имя');
            $table->string('HGM_LEADER_LASTNAME')->nullable()
                ->comment('Оснoвания для принятия декларации о соответствии. Данные о ООС. Руководитель. Фамилия');
            $table->string('HGM_LEADER_FATHERNAME')->nullable()
                ->comment('Оснoвания для принятия декларации о соответствии. Данные о ООС. Руководитель. Отчество');

            $table->string('HGM_PHONE')->nullable()
                ->comment('Оснoвания для принятия декларации о соответствии. Данные о ООС. Телефон');
            $table->string('HGM_FAX')->nullable()
                ->comment('Оснoвания для принятия декларации о соответствии. Данные о ООС. Факс');
            $table->string('HGM_EMAIL')->nullable()
                ->comment('Оснoвания для принятия декларации о соответствии. Данные о ООС. Адрес электронной почты');
            $table->string('HGM_ADDRESS1')->nullable()
                ->comment('Оснoвания для принятия декларации о соответствии. Данные о ООС. Место нахождение (юридический адрес)');
            $table->string('HGM_ADDRESS2')->nullable()
                ->comment('Оснoвания для принятия декларации о соответствии. Данные о ООС. Место осуществления деятельности (фактический адрес)');

            $table->string('HGM_EXPERT_NAME')->nullable()
                ->comment('Оснoвания для принятия декларации о соответствии. Данные о ООС. Эксперт. Имя');
            $table->string('HGM_EXPERT_LASTNAME')->nullable()
                ->comment('Оснoвания для принятия декларации о соответствии. Данные о ООС. Эксперт. Фамилия');
            $table->string('HGM_EXPERT_FATHERNAME')->nullable()
                ->comment('Оснoвания для принятия декларации о соответствии. Данные о ООС. Эксперт. Отчество');
    ...
    {
        Schema::drop('armnab_am_certList_Decl01RU');
    }
}
