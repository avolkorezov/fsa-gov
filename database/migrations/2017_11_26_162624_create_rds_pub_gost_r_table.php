...
class CreateRdsPubGostRTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rds_pub_gost_r', function(Blueprint $table){
            $table->increments('id');
            ...
            $table->text('a_manufacturer_type-iul')->nullable()->comment('Сведения о заявителе, изготовителе, продукции. Тип изготовителя');
            ...
            $table->text('a_applicant_info-rds-app_legal_person-legal_form')->nullable()->comment('Сведения о юридическом лице (заявитель). Организационно-правовая форма');
            ...
            $table->text('a_applicant_info-rds-app_legal_person-short_name_gost_r')->nullable()->comment('Сведения о юридическом лице (заявитель). Сокращенное наименование');
            ...
            $table->text('a_manufacturer_info-rds-man_foreign_legal_person-address_actual')->nullable()->comment('Сведения об изготовителе иностранном юридическом лице (изготовитель). Фактический адрес');
...
//            $table->text('')->nullable()->comment('Сведения об испытательной лаборатории. Прочие документы, послужившие основанием выдачи сертификата');
            ...
            $table->text('a_product_info-rds-product_gost_r-object_type_cert')->nullable()->comment('Сведения о продукции. «Тип объекта сертификации»: серийный выпуск, партия, единичное изделие');
            $table->text('a_product_info-rds-product_gost_r-product_type')->nullable()->comment('Сведения о продукции. Вид продукции');
            $table->text('a_product_info-rds-product_gost_r-product_name')->nullable()->comment('Сведения о продукции. Полное наименование продукции');
            $table->text('a_product_info-rds-product_gost_r-product_info')->nullable()->comment('Сведения о продукции. Сведения о продукции (тип, марка, модель, сорт, артикул и др.), обеспечивающие ее идентификацию');
            $table->text('a_product_info-rds-product_gost_r-okp')->nullable()->comment('Сведения о продукции. Код ОКП');
            $table->text('a_product_info-rds-product_gost_r-okp_text')->nullable()->comment('Сведения о продукции. Код ОКП');
            $table->text('a_product_info-rds-product_gost_r-okpd2')->nullable()->comment('Сведения о продукции. Коды ОКПД 2');
            $table->text('a_product_info-rds-product_gost_r-okpd2_text')->nullable()->comment('Сведения о продукции. Коды ОКПД 2');
            $table->text('a_product_info-rds-product_gost_r-tn_ved')->nullable()->comment('Сведения о продукции. Код ТН ВЭД ЕАЭС');
            $table->text('a_product_info-rds-product_gost_r-tn_ved_text')->nullable()->comment('Сведения о продукции. Код ТН ВЭД ЕАЭС');
            $table->text('a_product_info-rds-product_gost_r-name_doc_made_product')->nullable()->comment('Сведения о продукции. Наименование и реквизиты документа, в соответствии с которыми изготовлена продукция');
            $table->text('a_product_info-rds-product_gost_r-product_info_ext')->nullable()->comment('Сведения о продукции. Иная информация, идентифицирующая продукцию');
            $table->text('a_product_info-rds-product_gost_r-serial_number_product')->nullable()->comment('Сведения о продукции. Размер партии или заводской номер изделия');
            $table->text('a_product_info-rds-product_gost_r-requisites_doc')->nullable()->comment('Сведения о продукции. Реквизиты товаросопроводительной документации');
...
//            $table->text('tech_reg')->nullable()->comment('Сведения о документах, на основании которых изготовлена продукция. Технический регламент');
            $table->text('rds-standart_requlations-notation_national_standart')->nullable()->comment('Сведения о документах, соответствие которым подтверждено декларацией. Обозначение национального стандарта или свода правил');
