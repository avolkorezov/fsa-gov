...
class CreateArmnabAmLaboratoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('armnab_am_laboratory', function(Blueprint $table){
            $table->increments('id');

            $table->string('AP_NUMBER')->unique()->comment('APNumber');

            $table->string('STATUS')->nullable()->comment('Статус');
            $table->string('HGM_NAME')->nullable()->comment('Название лаборатории');
            $table->text('Addresses')->nullable()->comment('Адрес(а) испытательной лаборатории');
            $table->string('PHONE')->nullable()->comment('Телефон');
            $table->string('FAX')->nullable()->comment('Факс');
            $table->string('EMAIL')->nullable()->comment('Адрес электронной почты');

            $table->string('HGM_LEADER_NAME')->nullable()->comment('Руководитель испытательной лаборатории. Имя');
            $table->string('HGM_LEADER_LASTNAME')->nullable()->comment('Руководитель испытательной лаборатории. Фамилия');
            $table->string('HGM_LEADER_FATHERNAME')->nullable()->comment('Руководитель испытательной лаборатории. Отчество');
    ...
    {
        Schema::drop('armnab_am_laboratory');
    }
}
